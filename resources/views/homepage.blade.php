...
<head>
    ...
    <title>Publ - Incident Reporting System</title>
...
<body>
        ...
        <nav>
            ...
            <div class="nav-links" id="navLinks">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('report') }}">NOTIFICATION</a></li>
                    <li><a href="{{ route('verify') }}">PRIORITY</a></li>
    ...
    <section class="how-it-works">
        <div class="services">
            <h1 class="section-title"><b>How PubL Works</b></h1>
