      ...
      <div class="modal-body" style="padding: 0;">
        <div class="edit-profile-container">
          ...
          <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <input type="text" id="editName" name="name" value="{{ Auth::user()->name }}" required>
            ...
            <input type="tel" id="editPhone" name="phone" value="{{ Auth::user()->phone ?? '' }}" placeholder="Enter your phone number">

            <label for="editBio">Bio</label>
            <textarea id="editBio" name="bio" rows="3" placeholder="Tell us about yourself">{{ Auth::user()->bio ?? '' }}</textarea>
